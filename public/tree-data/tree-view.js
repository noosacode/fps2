...
const viewTag = viewParams.get("tag");
...
const fields = [
  ...
  ["Position", "position"],
  ["Colour", "colour"],
  ["WooCommerce status", "wcStatus"],
  ["WooCommerce last changed", "wcLastChanged", "date"],
  ["Sell score", "sellScore"],
  ["Bag size", "bagSize"],
  ["Price", "price"],
  ["Photo quality", "photoQuality"],
  ["Best photo date", "bestPhotoDate", "date"],
  ["Recent photo date", "recentPhotoDate", "date"],
  ["Transport size", "transportSize"],
...
function displayValue(value, type) {
  ...
  return type === "date" ? new Date(value).toLocaleDateString() : String(value);
}
